    ...
    return (
        <main className="flex h-screen w-full bg-neutral-50 dark:bg-neutral-900 text-neutral-900 dark:text-neutral-100 overflow-hidden font-sans transition-colors duration-200">
            ...
            <section className="flex-1 bg-neutral-100 dark:bg-neutral-950 flex flex-col relative transition-colors duration-200">
                <header className="h-14 border-b border-neutral-200 dark:border-neutral-800 flex items-center px-6 justify-between bg-white dark:bg-neutral-900 transition-colors duration-200shrink-0">
            ...
            <aside className="w-72 bg-white dark:bg-neutral-800 border-l border-neutral-200 dark:border-neutral-700 flex flex-col transition-colors duration-200">
                <header className="p-4 border-b border-neutral-200 dark:border-neutral-700 shrink-0">
                    <h2 className="font-semibold text-sm">Catálogo de Blocos</h2>
                </header>
